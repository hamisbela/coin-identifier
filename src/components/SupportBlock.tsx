  ...
  return (
    <div className="bg-gradient-to-r from-amber-100 to-yellow-100 rounded-2xl p-8 text-center">
      <div className="max-w-2xl mx-auto">
        ...
        <h2 className="text-3xl font-bold text-amber-600 mb-4">Support Our Work ❤️</h2>
        <p className="text-gray-700 mb-6">
          Help us maintain and improve our free coin identifier by supporting us.
          Your contribution helps keep this educational tool free for all numismatic enthusiasts! 🪙
        </p>
        <a
